...
public class StarGroupHandler extends AGroupHandler {

  private ParseResult result;

  public StarGroupHandler() {
  ...
  public void process(KeySymbol sym, DefinitionContext context) {
    ...
    pbean.insert(context.getLevel(), Template.PARSER_STAR_GROUP_BLOCK.toString(), result);
    pbean.replaceAll(PlaceHolder.BOOL, (context.getIndex() == 0 ? "true" : "false"), result);
  ...
  public void process(PredefinedSymbol sym, DefinitionContext context) {
    ...
    super.process(context.getLevel(), sym, context, Operator.STAR);
